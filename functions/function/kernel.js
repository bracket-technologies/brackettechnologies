...
const kernel = ({ _window, lookupActions, awaits = [], id = "root", path, value, key, object, __, e, mount, condition, toView, _object }) => {
    ...
    var answer = path.reduce((o, k, i) => {
        ...
        if (k0 === "log()" || k0 === "lg()") { // log()
            ...
            while (toApproval({ _window, lookupActions, awaits, id, string: args[1], __: my__, e, object: underScored ? object : o })) {
                toValue({ _window, lookupActions, awaits, id, value: args[2], __, e, object: underScored ? object : o })
            }

            if (args[3]) toValue({ _window, lookupActions, awaits, id, value: args[3], __,  e, object: underScored ? object : o, mount, toView })
            ...
            if (k0.slice(0, 6) === "coded@") _coded = toValue({ _window, lookupActions, awaits, id, e, value: global.__codes__[k0], __: my__, object })
            else if (k0.slice(0, 7) === "codedT@") _coded = global.__codes__[k0]

            if (i === lastIndex && key && value !== undefined) answer = o[_coded] = value
            else if (key && value !== undefined && o[_coded] === undefined) {
              
              if (!isNaN(toValue({ _window, lookupActions, awaits, id, value: path[i + 1], __, e }))) answer = o[_coded] = []
            ...
            if (args[1]) _params = toParam({ _window, lookupActions, awaits, id, e, __, string: args[1] })
            ...
            if (args[1]) {
                ...
                if (isParam({ _window, string: args[1] })) {
                    ...
                    _params = toParam({ _window, lookupActions, awaits, id, e, __, string: args[1] })
                    _tag_name = _params.tag || _params.tagName

                } else _tag_name = toValue({ _window, lookupActions, awaits, id, e, __, value: args[1] })
            } else _o = o
          ...
          if (args[1]) return lengthConverter(toValue({ _window, lookupActions, awaits, id, e, __, value: args[1] }))
          ...
          if (args[1]) {
            var _params = toParam({ _window, lookupActions, awaits, id, e, __, string: args[1] })
          ...
          installApp()
            ...
            var _params = {}, _timer
            if (args[1]) _timer = toValue({ _window, lookupActions, awaits, id, e, __, value: arg })
            else _timer = o
            ...
            var myFn = () => { toParam({ _window, lookupActions, awaits, id, string: args[1], __, e, object, toView }) }
            ...
            var _next = toValue({ _window, lookupActions, awaits, id, value: args[1], __,  e })
          ...
          var _files = toValue({ _window, lookupActions, awaits, id, value: args[1], __, e })
          ...
          _files.map(file => {
            ...
            reader.onload = (e) => {
              ...
              if (global.__counter__[__key].count === global.__counter__[__key].length) {
                ...
                toParam({ _window, lookupActions, awaits, id, e, __, string: args[2] })
              }
          ...
          var _item = toValue({ _window, lookupActions, awaits, id, value: args[1], __, e, object })
          var _index = 0
          ...
          answer = o
            ...
            if (args[1]) {
                var _id = toValue({ _window, lookupActions, awaits, id, value: args[1],_ ,e })
            ...
            var _params = toParam({ _window, lookupActions, awaits, e, id, string: args[1], __ })
          ...
          if (Array.isArray(o)) answer = o.length
            ...
            require(toValue({ _window, lookupActions, awaits, id, e, __,  value: args[1] }))

        } else if (k0 === "new()") { //new():Class:1:2:3...
            
          var myparams = [], _className = toValue({ _window, lookupActions, awaits, id, e, __, value: args[1] })
          args.slice(1).map(arg => {
            myparams.push(toValue({ _window, lookupActions, awaits, id, e, __,  value: arg || "" }))
          })
          if (_className && typeof (new [_className]()) === "object") answer = new [_className](...myparams)
            ...
            var _o
            if (args[1]) _o = toValue({ _window, lookupActions, awaits, id, e, value: args[1], __ })
            else _o = o
            ...
            if (isParam({ _window, string: args[1] })) {
                ...
                var _options = toParam({ _window, lookupActions, awaits, id, e, __,  string: args[1] })
              ...
              var format = toValue({ _window, lookupActions, awaits, id, e, value: args[1], __ }) || "format1"
            ...
            if (isParam({ _window, string: args[1] })) {
                ...
                _params = { date: toValue({ _window, lookupActions, awaits, id, e, value: args[1], __ }) }
            } else _params = { date: o }
          ...
          var _options = {}
          if (isParam({ _window, string: args[1] })) _options = toParam({ _window, lookupActions, awaits, id, e, __,  string: args[1] })
          else _options = toValue({ _window, lookupActions, awaits, id, e, value: args[1], __ })
          ...
          answer = require("./counter").counter({ ..._options })
            ...
            if (args[2]) {
                ...
                address = { id: generate(), hold: true, await: _await, requesterID: id, creationDate: (new Date()).getTime(), callerActionName: "import()" }
            ...
            if (_params.type === "json") {
                ...
                importJson({ _window, address, lookupActions, awaits, id, e, __ })
                return true

            } else {

                require(toValue({ _window, lookupActions, awaits, address, id, e, __, value: args[1] }))
            }
            ...
            if (noargs) answer = toArray(o).filter(o => o !== "" && o !== undefined && o !== null)
                ...
                if (underScored === 2) answer = toArray(o).filter((o, index) => toApproval({ _window, lookupActions, awaits, e, string: arg, id, __: [o, index, ...__] }) )
                else if (underScored === 1) answer = toArray(o).filter((o) => toApproval({ _window, lookupActions, awaits, e, string: arg, id, __: [o, ...__] }) )
                else answer = toArray(o).filter((o) => toApproval({ _window, lookupActions, awaits, e, string: arg, id, object: o, __ }))
            })
            ...
            if (i === lastIndex && key && value !== undefined) {
                ...
                if (underScored === 2) _index = toArray(o).findIndex((o, index) => toApproval({ _window, lookupActions, awaits, e, string: args[1], id, __: [o, index, ...__] }) )
                else if (underScored === 1) _index = toArray(o).findIndex((o, index) => toApproval({ _window, lookupActions, awaits, e, string: args[1], id, __: [o, ...__] }) )
                else _index = toArray(o).findIndex(o => toApproval({ _window, lookupActions, awaits, e, string: args[1], id, __, object: o }) )
                
                if (_index !== undefined && _index !== -1) o[_index] = answer = value
                
            } else {

                if (underScored === 2) answer = toArray(o).find(o => toApproval({ _window, lookupActions, awaits, e, string: args[1], id, __: [o, index, ...__] }) )
                else if (underScored === 1) answer = toArray(o).find(o => toApproval({ _window, lookupActions, awaits, e, string: args[1], id, __: [o, ...__] }) )
                else answer = toArray(o).find(o => toApproval({ _window, lookupActions, awaits, e, string: args[1], id, __, object: o }) )
            }
            ...
            if (underScored === 2) answer = toArray(o).findIndex((o, index) => toApproval({ _window, lookupActions, awaits, e, string: args[1], id, __: [o, index, ...__] }) )
            else if (underScored === 1) answer = toArray(o).findIndex(o => toApproval({ _window, lookupActions, awaits, e, string: args[1], id, __: [o, ...__] }) )
            else answer = toArray(o).findIndex(o => toApproval({ _window, lookupActions, awaits, e, string: args[1], id, __, object: o }) )
            ...
            if (underScored === 1) {
              ...
              toArray(o).map(o => reducer({ _window, lookupActions, awaits, id, path: args[1] || [], value, __: [o, ...__], e, object, toView }) )
              answer = o
                
            } else if (underScored === 2) {
              
              toArray(o).map((o, index) => reducer({ _window, lookupActions, awaits, id, path: args[1] || [], value, __: [o, index, ...__], e, object, toView }) )
              answer = o
              
            } else {
              answer = toArray(o).map(o  => reducer({ _window, lookupActions, awaits, id, path: args[1] || [], object: o, value, __, e, toView }) )
            }
            ...
            if (isParam({ _window, string: args[1] })) {
                ...
                _params = toParam({ _window, lookupActions, awaits, id, e, _, string: args[1] })
                _el = _params.element || _params.id || _params.view || o

            } else if (args[1]) _el = toValue({ _window, lookupActions, awaits, id, e, __, value: args[1] })
            else if (o) _el = o
            ...
            if (args[2]) {
                _await = global.__codes__[args[2]]
                address = { id: generate(), hold: true, await: _await, requesterID: id, creationDate: (new Date()).getTime(), callerActionName: "html2pdf()" }
                awaits.unshift(address)
                        ...
                        toDataURL(image.src).then(dataUrl => {
                            ...
                            if (images.length === i + 1) {
                                ...
                                if (!once && pages.length > 1 && pages.length === _elements.length) {
                                    ...
                                    once = true
                                    exportHTMLToPDF({ _window, pages: _elements, opt, lookupActions, awaits, address, id, e, __, args })
                                    ...
                                    // await params
                                    if (args[2]) toAwait({ _window, lookupActions, awaits, address, id, e, __: [pdf, __] })
            ...
            if (isParam({ _window, string: args[1] })) { // share():[text;title;url;files]
                ...
                var _params = toParam({ _window, lookupActions, awaits, id, e, __, string: args[1] }) || {}, images = []
                ...
                navigator.share({ url: toValue({ _window, lookupActions, awaits, id, e, __, value: args[1] })})
            }
          ...
          if (!isNaN(o)) {
            var nth = toValue({ _window, lookupActions, awaits, id, e, __, value: args[1] }) || 2
            ...
            // getCookie():name
            var _name = toValue({ _window, lookupActions, awaits, id, e, __,  value: args[1] })
            ...
            if (isParam({ _window, string: args[1] })) {
                ...
                args.slice(1).map(arg => {
                    ...
                    var _params = toParam({ _window, lookupActions, awaits, id, e, __, string: arg })
                ...
                var _name = toValue({ _window, lookupActions, awaits, id, e, __,  value: args[1] })
                var _value = toValue({ _window, lookupActions, awaits, id, e, __,  value: args[2] })
                var _expiryDate = toValue({ _window, lookupActions, awaits, id, e, __,  value: args[3] })
            ...
            var splited = toValue({ _window, lookupActions, awaits, id, e, __, value: args[1] })
            answer = o.split(splited)

        } else if (k0 === "join()") {

            var joiner = toValue({ _window, lookupActions, awaits, id, e, value: args[1] || "", __ })
            ...
            if (isParam({ _window, string: args[1] })) {
                ...
                require("./route").route({ _window, lookupActions, awaits, id, route })
                ...
                require("./route").route({ _window, lookupActions, awaits, id, route: { path: _path, page: _page } })
            }

        } else if (k0 === "createDoc()") {

            var address = addresser({ hold: true, await: args[2], DOMRendering: true, renderingID: o.__view__ ? o.id : id, requesterID: id, callerActionName: "createDoc()" })
            createDoc({ _window })
            ...
            require("./toggleView").toggleView({ _window, lookupActions, awaits, toggle, id: o.id })
            return true
            ...
            var mininoteControls = toCode({ _window, string: `():mininote-text.txt()=${_text};clearTimer():[__mininoteTimer__:()];():mininote.style():[opacity=1;transform=scale(1)];__mininoteTimer__:()=timer():[():mininote.style():[opacity=0;transform=scale(0)]]:3000` })
            return toParam({ _window, string: mininoteControls, e, id, __ })

        } else if (k0 === "tooltip()") {
          
            var _text = toValue({ _window, id, e, __, value: args[1] })
            var mininoteControls = toCode({ _window, string: `():tooltip-text.txt()=${_text};clearTimer():[__tooltipTimer__:()];():tooltip.style():[opacity=1;transform=scale(1)];__tooltipTimer__:()=timer():[():tooltip.style():[opacity=0;transform=scale(0)]]:500` })
            return toParam({ _window, string: mininoteControls, e, id, __ })
            ...
            } else func({ _window, id, e, action: { actions: decode({ _window, string: k }) }, __, lookupActions, awaits, address })
            ...
            var address = addresser({ hold: true, await: args[2], DOMRendering: true, renderingID: o.__view__ ? o.id : id, requesterID: id, callerActionName: "update()" })

            require("./update").update({ _window, lookupActions, awaits, id: o.id, mainId: id, address, __ })
            return ({ __asynchronous__: true, __action__: "update()" })

        } else if (k0 === "upload()") {

            var address = addresser({ hold: true, await: args[2], requesterID: id, callerActionName: "upload()" })
            var data = toParam({ _window, id, e, __,  string: args[1] })
            require("./upload")({ _window, lookupActions, awaits, id, address, e, __,  upload: data })
            return ({ __asynchronous__: true, __action__: "upload()" })

        } else if (k0 === "confirmEmail()") {

            var address = addresser({ hold: true, await: args[2], requesterID: id, callerActionName: "confirmEmail()" })
            var data = toParam({ _window, lookupActions, id, e, __, string: args[1] })
            data.store = "confirmEmail"
            require("./save").save({ id, lookupActions, awaits, address, e, __, save: data })
            return ({ __asynchronous__: true, __action__: "confirmEmail()" })

        } else if (k0 === "save()") {
          
            var address = addresser({ hold: true, await: args[2], requesterID: id, callerActionName: "save()" })
            var data = toParam({ _window, lookupActions, id, e, __,  string: args[1] })
            require("./save").save({ _window, lookupActions, awaits, id, e, __, address, save: data })
            ...
            var address = addresser({ hold: true, await: args[2], requesterID: _id, callerActionName: "insert()" })
            var data = toValue({ _window, lookupActions, id, e, __, value: args[1], object })
            insert({ id: data.id || _id, insert: data, lookupActions, awaits, address, __ })
            return ({ __asynchronous__: true, __action__: "insert()" })

        } else if (k0 === "mail()") {

            var address = addresser({ hold: true, await: args[2], requesterID: id, callerActionName: "mail()" })
            var data = toParam({ _window, id, e, __,  string: args[1] })

            if (!_window) {

                var _func = { data, actions: `mail():[subject=_.subject;content=_.content;text=_.text;html=_.html;recipient=_.recipient;recipients=_.recipients;attachments=_.attachments]:[send():_]` }
                return func({ _window, id, lookupActions, awaits, address, e, func: _func, __ })
            }

            else require("./mail").mail({ _window, lookupActions, awaits, address, id, e, __ })
            return ({ __asynchronous__: true, __action__: "mail()" })

        } else if (k0 === "print()") {

            var address = addresser({ hold: true, await: args[2], requesterID: id, callerActionName: "print()" })
            var data = toValue({ _window, lookupActions, awaits, id, e, __, value: args[1] })
            if (!data.id && !data.view) data.id = o.id
            if (data.view) data.id = data.view.id

            require("./print").print({ id, options: data, lookupActions, awaits, address, id, e, __ })
                ...
                ([...data.files]).map(file => {
                    ...
                    reader.onload = (e) => {
                        ...
                        if (global.__COUNTER__[__key].count === global.__COUNTER__[__key].length) {
                            ...
                            toParam({ _window, lookupActions, awaits, id, e, __: [global.files.length === 1 ? global.files[0] : global.files, ...__.slice(0, 9)],  string: args[2] })
                        } 
                    }
            ...
            var address = addresser({ hold: true, await: args[2], requesterID: id, callerActionName: "view()" })
            var data = isParam({ _window, string: args[1] }) ? toParam({ _window, id, e, string: args[1] || "", __ }) : { view: toValue({ _window, id, e, __, value: args[1] }) }
            toView({ _window, id: o.__view__ ? o.id : id, awaits, lookupActions, address, __, e, ...data })

            return ({ __asynchronous__: true, __action__: "view()" })

        } else if (k0 === "search()") {

            var address = addresser({ hold: true, await: args[2], requesterID: id, callerActionName: "search()" })
            var data = toParam({ _window, id, e, __, string: args[1] })
            require("./search").search({ _window, lookupActions, awaits, address, id, e, __, search: data })

            return ({ __asynchronous__: true, __action__: "search()" })

        } else if (k0 === "erase()") {

            var address = addresser({ hold: true, await: args[2], requesterID: id, callerActionName: "erase()" })
            var data = toParam({ _window, id, e, __,  string: args[1] })
            require("./erase").erase({ _window, lookupActions, awaits, address, id, e, __, erase: data })
          ...
          if (data.from === "csv" && data.to === "json") require("./csvToJson").csvToJson({ id, lookupActions, awaits, e, file, onload: args[2] || "", __ })
            ...
            var text 
            if (args[1]) text = toValue({ _window, awaits, id, e, __, value: args[1] })
            else text = o
            ...
            global.__actionReturns__[0].value = toValue({ _window, value: args[1], e, id, object: object || o, __, awaits, lookupActions })
            global.__actionReturns__[0].returned = true

        } else if (k0.length === 13 && k0.slice(-2) === "()" && k0.slice(0, 6) === 'coded@') { // [actions?conditions?elseActions]():[params]:[awaits]
            ...
            var address = addresser({ hold: true, await: args[2], requesterID: id, callerActionName: "[...]()" })
            ...
            global.__waiters__.unshift(address.id)

            if (!condition) {

                answer = toValue({ _window, value: k0, e, id, object: object || o, __: my__1, awaits, lookupActions })
                if (executable({ _window, string: answer })) {

                    answer = toCode({ _window, string: toCode({ _window, string: answer, start: "'" }) })
                    answer = toValue({ _window, value: answer, e, id, object: object || o, __: my__1, awaits, lookupActions })
                ...
                answer = toApproval({ _window, string: answer, e, id, object: object || o, __: my__1, awaits, lookupActions })
            }
            ...
            // unexecuted wait
            checkUnexecutedAwait({ _window, id, awaits, lookupActions, e, address, data, __: [global.search, ...my__] })

        } else if (k0.slice(-2) === "()") { // execute action
            
            return toAction({ _window, lookupActions, awaits, id, __, e, path: [k], path0: k0, condition, mount, toView, object })

        } else if (k0.includes("()") && typeof o[k0.slice(0, -2)] === "function") { // it is a function
          
            var myparams = args.slice(1).map(arg => toValue({ _window, lookupActions, awaits, id, e, __, value: arg || "" }))
            answer = o[k0.slice(0, -2)](...myparams)

        } else if (k0 === "action" && toView) { // action:[...]

            var event = global.__codes__[args[1]]
        ...
        } /*else if (k0 === "child" && toView) { // child:[...]

            if (!args[1]) return o
            var myview = global.__codes__[args[1]]

            if (k0 === "child") { // children

                var _children = []
                _children.push({ view: myview })
            ...
            if (k.includes("coded@")) {
              ...
              k.split("coded@").slice(1).map(code => {
                _key += toValue({ _window, lookupActions, awaits, value: global.__codes__[`coded@${code.slice(0, 5)}`], __, id, e, object })
                _key += code.slice(5)
              })
