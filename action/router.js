...
module.exports = async ({ req, res }) => {
  ...
  // address toView
  var address = addresser({ _window, id, status: "Start", type: "function", function: "toView", stack, __, data: { view }, logger: { key: "router", end: true } }).address

  // render router
  toView({ _window, req, res, stack, __, address, lookupActions: view.__lookupActions__, data: { view } })
